...
{
	public static int Int(String mensagem, String titulo) {
		int entradaInt;
	...
	public static double Double(String mensagem, String titulo) {
	...
	public static char Char(String mensagem, String titulo) {
		char entradaChar;
